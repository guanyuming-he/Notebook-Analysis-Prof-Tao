...
After we have the cancellation law, we can prove what Prof.~Tao referred to as the natural numbers being distinct. However, the proof depends on addition, which uses the informal Proposition~2.1.16, so we will have to wait until \exerciseref{3.5.12} to eventually formalise it.
