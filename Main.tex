...
\newpage
%\include{Integers and Rationals}

\newpage
%\include{The Real Numbers}

\newpage
%\include{Limit of Sequences}

\newpage
%\include{Series}

\newpage
%\include{Infinite Sets}

\newpage
%\include{Continuous Functions on R}
...
%\include{Uniform convergence}


%\include{AnswersTable}
