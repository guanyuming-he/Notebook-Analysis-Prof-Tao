...
\begin{exercise}{3.5.12}	
	...
	\begin{align*}
		a(0) &= c \in X \\
		a(\successor{n}) &= f(n,a(n)), \hbox{ for all } n \in \setn
	\end{align*}
...
\begin{proof}
	I asked Prof.~Tao about this exercise, because I am uncertain about something. It is left untouched until Prof.~Tao replies or until I found the problem.
\end{proof}
